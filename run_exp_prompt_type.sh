...
PROMPT_TYPES="python_list_plus python_string_plus"
...
mkdir -p logs/multi_prompt_eval
...
for i in "${!models[@]}"; do
    ...
    log_file="logs/multi_prompt_eval/run_${model_name}_gpu${gpu}.log"
...
echo "Check logs/multi_prompt_eval directory for outputs."
...
#     --prompt-types "python_stack_plus" "python_list_plus" "python_string_plus" \
